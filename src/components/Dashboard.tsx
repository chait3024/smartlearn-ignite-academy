...
import { BookOpen, User, BookText, Users, Calendar, Image, Search, FileText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Learning Dashboard</h2>
          <p className="text-lg text-gray-600">Choose a tool to enhance your learning experience</p>
        </div>
